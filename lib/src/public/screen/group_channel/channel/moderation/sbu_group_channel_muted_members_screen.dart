...
class SBUGroupChannelMutedMembersScreen extends SBUStatefulComponent {
  final int messageCollectionNo;

  const SBUGroupChannelMutedMembersScreen({
  ...
  State<StatefulWidget> createState() =>
      SBUGroupChannelMutedMembersScreenState();
}

class SBUGroupChannelMutedMembersScreenState
    extends State<SBUGroupChannelMutedMembersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final mutedMembers =
        sortedMembers?.where((member) => member.isMuted).toList();
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        return SBUUserListItemComponent(
                          ...
                          moderationType: SBUModerationType.mutedMembers,
                        );
                      },
                    ),
                  )
